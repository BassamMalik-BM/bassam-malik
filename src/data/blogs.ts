...
export const blogPosts: BlogPost[] = [
  {
  slug: "best-crypto-books-for-beginners",
  title: "Best Crypto Books for Beginners.",
  description:
    "Discover beginner-friendly crypto books to learn Bitcoin, investing mindset, and safer decision-making.",
 ...
 },
 {
  ...
  title: "Is Crypto Safe for Beginners?",
  description:
    'Learn whether crypto is safe for beginners, the biggest risks to understand, and how to start learning responsibly without hype or fear.',
  category: 'Beginner Guides',
  readingTime: '13 min read',
  content: [],
 },
