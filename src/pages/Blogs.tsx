          ...
          <div className="mb-14 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <h1 className="max-w-3xl text-4xl font-bold tracking-tight text-slate-950 dark:text-white md:text-5xl">
                Crypto insights, guides, and beginner articles
              </h1>

              <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-300">
                Explore beginner-friendly crypto articles, practical tips,
                platform guides, market concepts, and educational content
                designed to help you learn with confidence.
              </p>
            </div>
          ...
          {currentPosts.length > 0 ? (
            ...
            <div className="premium-card text-center">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-300">
                Try searching for beginner, books, websites, apps, or roadmap.
              </p>
            </div>
          )}
        </div>
